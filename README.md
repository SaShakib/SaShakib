...
With 7 years of experience, I co-founded and led development at **Insabn**, delivering end-to-end solutions across industries. Notable projects include:

- 🚀 **Waliey** – Online retail network of 50+ shops, serving hyperlocal e-commerce needs
- 📰 **RobiNewsBD** – SEO-first news portal with 2s load time and thousands of monthly readers
- 🍽️ **HungrySmile POS** – POS with inventory, sales analytics, and reporting (Laravel + React)
...
|--------|-------------|------------|
| **Blink-Controlled RC Car** | Controlled an RC car using EEG signals with 88% accuracy and <1 s latency | Python · Muse · ESP8266 · React · C++ |
| **Waliey Retail Network** | Geo‑sorted marketplace for 50+ local shops, enabling users to order real store products online | MERN Stack · Location-based APIs |
| **RobiNewsBD Portal** | Fast, SEO‑optimized local news site with <2 s load time and thousands of readers | React · Node.js · SSR |
| **HungrySmile POS System** | Laravel+React system supporting orders, inventory, expenses, and analytics | Laravel · MySQL · React |
| **Scheduling App (Akbar Tech)** | Multi-region booking engine with timezone normalization, idempotent APIs, caching, and analytics dashboards | TypeScript · NestJS · AWS · Kafka · Redis |
